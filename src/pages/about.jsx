...
export default function About() {
  return (
    <>
      <Head>
        <title>About - Swati Gupta</title>
        <meta
          name="description"
          content="I’m Swati Gupta. I live in Bengaluru City, where I develop the future."
        />
      </Head>
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            ...
            <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
              <p>
                ...
                freelancer extraordinaire. With 8 years of experience under my
          ...
          <div className="lg:pl-20">
            <ul role="list">
              ...
              <SocialLink
                href="mailto:swati.gu11@gmail.com"
                icon={MailIcon}
                className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40"
              >
                swati.gu11@gmail.com
              </SocialLink>
            </ul>
          </div>
        </div>
